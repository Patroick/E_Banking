...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-sm-3 border rounded m-1 pt-3"
                ...
                <form name="logout"
                    ...
                    <button type="submit"
                            name="logout"
                            class="btn btn-primary mb-3">Ausloggen</button>
                </form>
            </div>
            ...
            <div class=" col-sm-3 border rounded m-1 text-truncate pt-3"
                ...
                <form name="transaction"
                    ...
                    <button type="submit"
                            name="transaction"
                            class="btn btn-primary">Überweisung</button></br></br>
                </form>
                <form name="transactionHistory"
                      action="ebanking.php"
                      method="post">
                    <button type="submit"
                            name="transactionHistory"
                            class="btn btn-secondary"
                            style="background-color: green">Überweisungshistorie</button></br></br>
                </form>
            </div>
            <div class="col-sm-5 border rounded m-1 p-3"
                 style="max-height: 22em">
                <h3>Letzte Transaktionen</h3>
                <div class="table-responsive"
                     style="max-height: 17em">
                ...
                <div class="col-sm-11 border rounded m-1 pt-3 container">
                    <div class="form-group">
                        ...
                        <input type="text"
                               ...
                               id="recipient"
                               name="recipient"
                               placeholder="AT-XXXXXXXXXXXXXXXXXX">
                    </div>
                    ...
                    <button type="submit"
                            class="btn btn-primary mb-2 mt-2">Überweisung</button>
                </div>
                <?php
                }
                if(isset($_POST['transactionHistory'])){ ?>
                <div class="col-sm-11 border rounded m-1 p-3"
                     style="max-height: 30em">
                    <h3>Überweisungshistorie</h3>
                    <div class="row ">
                        <div class="col-sm-3">

                            <form name="sortByDate"
                                  action="ebanking.php"
                                  method="post">
